...
public final class BurtonsvilleEPA {
	private static org.apache.log4j.Logger log = Logger.getLogger(BurtonsvilleEPA.class);
	...
	public static final void initiate() {
		...
		log.info("BurtonsvilleEPA initiated");
	...
	private static void registerStatementUnderToActionStage() {
		String pattern = "SELECT a, b " +
				...
				"(a.value < ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_ACTION_STAGE)) +
				") -> b=WaterMLObservationEvent" +
				"(b.value > ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_ACTION_STAGE)) +
				"))] " +
				"WHERE (a.observer.id = '".concat(Integer.valueOf(FloodThresholds.BURTONSVILLE_SITE_CODE).toString()) + 
	...
	private static void registerStatementActionToMinorFlood() {
		String pattern = "SELECT a, b " +
		"FROM pattern [every (a=WaterMLObservationEvent" + 
		"(a.value < ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_MINOR_FLOOD_STAGE)) +
		") -> b=WaterMLObservationEvent" +
		"(b.value > ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_MINOR_FLOOD_STAGE)) +
		"))] " +
		"WHERE (a.observer.id = '".concat(Integer.valueOf(FloodThresholds.BURTONSVILLE_SITE_CODE).toString()) + 
		"') and (a.observer.id = b.observer.id)";
	...
	private static void registerStatementMinorToModerateFlood() {
		String pattern = "SELECT a, b " +
		"FROM pattern [every (a=WaterMLObservationEvent" + 
		"(a.value < ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_MODERATE_FLOOD_STAGE)) +
		") -> b=WaterMLObservationEvent" +
		"(b.value > ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_MODERATE_FLOOD_STAGE)) +
		"))] " +
		"WHERE (a.observer.id = '".concat(Integer.valueOf(FloodThresholds.BURTONSVILLE_SITE_CODE).toString()) + 
		"') and (a.observer.id = b.observer.id)";
	...
	private static void registerStatementModerateToMajorFlood() {
		String pattern = "SELECT a, b " +
		"FROM pattern [every (a=WaterMLObservationEvent" + 
		"(a.value < ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_MAJOR_FLOOD_STAGE)) +
		") -> b=WaterMLObservationEvent" +
		"(b.value > ".concat(String.valueOf(FloodThresholds.BURTONSVILLE_MAJOR_FLOOD_STAGE)) +
		"))] " +
		"WHERE (a.observer.id = '".concat(Integer.valueOf(FloodThresholds.BURTONSVILLE_SITE_CODE).toString()) + 
		"') and (a.observer.id = b.observer.id)";
